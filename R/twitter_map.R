...
# NOTE: The keys below won't actually work; I corrupted them before committing.
key <- 'aZolKBHmeUotTNpf5p1gk5SJ3'
secret <- 'S8wSc8KNImg12Ho1ydkzM7HkcX3GRx13JkFipWli4Bvw0mP8ER'
access <- '862564638-2vhtPUV2R5NVHzduKp9396jw1ipToSkT1k7KoFdQ'
access_secret <- '1wH5xEwB6Y7Pr5Ta6GNegFqDU6HOzIq17KMB0q3ib0e9Z'
